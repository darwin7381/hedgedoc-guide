...
**n8n Template 檔案**：[hedgedoc-create-and-read-template.json](https://raw.githubusercontent.com/darwin7381/hedgedoc-guide/main/workflows/hedgedoc-create-and-read-template.json)

**n8n Template URL**（可直接在 n8n 中 Import from URL）：
```
